...
const VO = {
  ...
  "a1-23-common-verbs": {
    hook: "با پنج اصطلاح کلیدی، کارهای روزانه را به آلمانی بیان کنید.",
    steps: [
      "کلمه اول را با صدای بلند تکرار کنید.",
      "این یکی را هم تکرار کنید.",
      "این یکی را چند بار بخوانید.",
      "این یکی را هم تمرین کنید.",
      "و کلمه آخر را هم تکرار کنید.",
    ],
    outro: "این پنج کلمه را چند بار تمرین کنید.",
  },
  "a1-24-clothes": {
