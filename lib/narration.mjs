...
const VO = {
  ...
  "a1-19-directions": {
    hook: "آدرس را به آلمانی بپرس و راهت را پیدا کن.",
    steps: [
      "این سؤال را برای پرسیدن مکان یک جا به کار ببر.",
      "این کلمه مستقیم رفتن را نشان می‌دهد.",
      "این دو کلمه چپ و راست هستند؛ در هر مسیری به کارت می‌آیند.",
      "و این جمله برای نزدیک بودن یک جا به کار می‌رود.",
    ],
