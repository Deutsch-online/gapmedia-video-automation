...
const VO = {
  ...
  "a1-23-common-verbs": {
    hook: "با پنج واژه، کارهای روزانه را به آلمانی بگو.",
    steps: [
      "واژه اول را با صدای بلند تکرار کن.",
      "واژه دوم را هم تکرار کن.",
      "واژه سوم را چند بار بخوان.",
      "واژه چهارم را هم تمرین کن.",
      "و واژه آخر را هم تکرار کن.",
    ],
    outro: "این پنج واژه را چند بار تکرار کن.",
  },
  "a1-24-clothes": {
