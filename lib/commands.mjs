...
export const HELP_TEXT =
  ...
  "📡 <b>Provider List</b>\n" +
  "• <b>پروایدرها</b> — وضعیت سرویس‌های جست‌وجو، ترجمه، صدا و ارسال؛ با ترتیب جایگزین خودکار\n\n" +
  ...
  "• <b>آلمانی بساز</b> / <b>درس آلمانی بساز</b> — درس بعدیِ سری A1 را همین حالا بساز، جدا از زمان‌بندی خودکار\n" +
